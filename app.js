...
const notifcationsApiRoute = require('./routes/api/notifications')
const messageApiRoute = require('./routes/api/messages')
const messageRoute = require('./routes/messagesRoutes')
const notificationsRoute = require('./routes/notificationRoutes')
const mongoose = require("./database")
const session = require('express-session');
const { search } = require('./routes/api/posts');
...
app.use('/api/notifications',notifcationsApiRoute)
...
io.on("connection",socket=>{
    ...
    socket.on("setup",userData => {
        socket.join(userData._id); // join a chat room 
